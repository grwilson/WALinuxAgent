...
class DelphixOSDeprovisionHandler(DeprovisionHandler):
    def __init__(self):
        super(DelphixOSDeprovisionHandler, self).__init__()

    def setup(self, deluser):
        warnings, actions = super(DelphixOSDeprovisionHandler, self).setup(deluser)
        ...
        # state on startup.
        #
        warnings.append("WARNING! The Delphix Management service will be stopped.")
